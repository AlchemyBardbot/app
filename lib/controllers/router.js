...
module.exports = async function router(keyword, args, message, connection) {
    switch (keyword) {
        case `${prefix}play`:
            ...
            message.channel.send('Genre needs to accompany the play command. Enter the genres command for a list of options!');
            break;
        ...
        case `${prefix}roll`:
            ...
            message.channel.send('Please provide a number for the roll feature!');
            break;
        default:
